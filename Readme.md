...
# Configuration Script – Incidentes - Rev. A

This **Configuration** script is designed for the **Incidentes** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – Incidentes Rev. A

Este script de **Configuration** está diseñado para el modelo **Incidentes** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
